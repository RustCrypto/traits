...
where
    ...
    FieldBytesSize<C>: ModulusSize,
{
    /// Serialize this [`PublicKey`] as a SEC1 [`Sec1Point`], optionally applying
    /// point compression
