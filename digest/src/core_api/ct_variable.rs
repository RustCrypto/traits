...
use crypto_common::{
    ...
    typenum::{Diff, IsLess, IsLessOrEqual, Le, LeEq, NonZero, Sum, U1, U256},
...
where
    ...
    Sum<T::SerializedStateSize, U1>: Sub<T::SerializedStateSize> + ArraySize,
    Diff<Sum<T::SerializedStateSize, U1>, T::SerializedStateSize>: ArraySize,
{
    type SerializedStateSize = Sum<T::SerializedStateSize, U1>;
